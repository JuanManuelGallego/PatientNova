...
import { PatientNotFoundError, LocationNotFoundError } from '../../../src/utils/errors/errors.js';
import { AppointmentNotFoundError } from '../../../src/appointments/appointment.errors.js';
import { ReminderNotFoundError } from '../../../src/reminders/reminder.errors.js';
import { AppointmentTypeNotFoundError } from '../../../src/appointment-types/appointment-type.errors.js';
import { MedicalRecordNotFoundError } from '../../../src/medical-records/medical-record.errors.js';
import {
  Channel,
  ReminderMode,
  ReminderStatus,
...
describe('tenant isolation: cross-entity guards', () => {
  ...
  it('appointmentRepository.create does not validate patient ownership (service layer does)', async () => {
    ...
    const { appointmentService } = await import('../../../src/appointments/appointment.service.js');
    const patientA = await createTestPatient(userA.id);
